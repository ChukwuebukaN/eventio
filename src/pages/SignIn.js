      ...
      <img src={LogoBlack} onClick={handleHomeRoute} className={screenIsMobile === 'true' ? 'logo-mobile' : 'hidden'} alt="Eventio Logo Black" />
        ...
        <form id='signin' onSubmit={handleSignIn} >
          <div className='onboarding-form'>
            <input type='email' className='onboarding-input' required value={email} onChange={(e) => handleEmailTransition(e.target.value)} />
          ...
          <div className='onboarding-form'>
            ...
            <input type={showPassword ? 'text' : 'password'} className='onboarding-input' required value={password} onChange={(e) => handlePasswordTransition(e.target.value)} />
          ...
          <div onClick={handleSignUpRoute} className={screenIsMobile === 'true' ? 'onboarding-signup-text-mobile' : 'hidden'}>
