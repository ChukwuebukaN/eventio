      ...
      <img src={LogoBlack} className={screenIsMobile === 'true' ? 'logo-mobile' : 'hidden'} alt="Eventio Logo Black" />
        ...
        <form id='signup' onSubmit={handleSignUp} >
          <div className='onboarding-form'>
            <input required type='text' className='onboarding-input' value={firstName} onChange={(e) => handleFirstnameTransition(e.target.value)}/>
            <label htmlFor='fistname' className={ inputFirstnameActive ? 'Active' : '' }>
              First Name
            </label>  
          </div>
          <div className='onboarding-form'>
            <input required type='text' className='onboarding-input' value={lastName} onChange={(e) => handleLastnameTransition(e.target.value)}/>
            <label htmlFor='Lastname' className={ inputLastnameActive ? 'Active' : '' }>
              Last Name
            </label>  
          </div>
          <div className='onboarding-form'>
            <input required type='email' className='onboarding-input' value={email} onChange={(e) => handleEmailTransition(e.target.value)}/>
          ...
          <div className='onboarding-form'>
            ...
            <input required type={showPassword ? 'text' : 'password'} className='onboarding-input' value={password} onChange={(e) => handlePasswordTransition(e.target.value)}/>
              <label htmlFor='' className={ inputPasswordActive ? 'Active' : '' }>
                Password 
              </label>
                <MdRemoveRedEye className='onboarding-input-icon' onClick={handleShowPassword} />
            </div>
          </div>
          <div className='onboarding-form'>
            <div className='onboarding-input-password'>
            <input required type={showPassword ? 'text' : 'password'} className='onboarding-input' value={passwordValidate} onChange={(e) => handlePasswordValidateTransition(e.target.value)}/>
              <label htmlFor='' className={ inputPasswordValActive ? 'Active' : '' }>
                Repeat Password 
              </label>
                <MdRemoveRedEye className='onboarding-input-icon' onClick={handleShowPassword} />
            </div>
        ...
        <div onClick={handleSignInRoute} className={ screenIsMobile === 'true' ? 'hidden' : 'onboarding-signup-text-desktop'}>
